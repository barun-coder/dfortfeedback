...
public class LicenseLoginViewModel extends BaseViewModel<LoginNavigator> {

    public LicenseLoginViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
