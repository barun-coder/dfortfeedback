...
//    static final String ENDPOINT_SERVER_GET_LANG_LIST = BuildConfig.BASE_URL + "multilingual/multilingual/getLanguage";
    ...
    static final String ENDPOINT_SERVER_FEEDBACK_QUESTION = "feedback/feedbackQuestion/lang:";
    static final String ENDPOINT_SERVER_SUBMIT_FEEDBACK = "feedback/feedback";
    static final String ENDPOINT_SERVER_GET_LANG_LIST = "multilingual/multilingual/getLanguage";
